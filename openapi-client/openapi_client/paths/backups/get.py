...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'instance_id': typing.Union[InstanceIdSchema, str, ],
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["backups", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["backups", "meta", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        backups: typing.Union[MetaOapg.properties.backups, list, tuple, schemas.Unset] = schemas.unset,
...
class ListBackups(BaseApi):
    ...
    def list_backups(
        ...
        return self._list_backups_oapg(
