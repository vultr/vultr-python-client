...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["neighbors", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["neighbors", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_instance_neighbors_oapg(
        self,
...
class GetInstanceNeighbors(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_instance_neighbors(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_instance_neighbors(
        ...
        return self._get_instance_neighbors_oapg(
