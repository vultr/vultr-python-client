...
class SchemaFor200ResponseBodyApplicationJson(
        ...
        class properties:
            ...
            class plans(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PlansMetal']:
                        return PlansMetal
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PlansMetal'], typing.List['PlansMetal']],
                ...
                def __getitem__(self, i: int) -> 'PlansMetal':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["plans", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["plans", "meta", ], str]):
...
class ListMetalPlans(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_metal_plans(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_metal_plans(
        ...
        return self._list_metal_plans_oapg(
