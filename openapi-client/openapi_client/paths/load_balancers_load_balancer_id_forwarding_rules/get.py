...
class SchemaFor200ResponseBodyApplicationJson(
        ...
        class properties:
            ...
            class forwarding_rules(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ForwardingRule']:
                        return ForwardingRule
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ForwardingRule'], typing.List['ForwardingRule']],
                ...
                def __getitem__(self, i: int) -> 'ForwardingRule':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["forwarding_rules", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["forwarding_rules", "meta", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_load_balancer_forwarding_rules_oapg(
        self,
...
class ListLoadBalancerForwardingRules(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_load_balancer_forwarding_rules(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_load_balancer_forwarding_rules(
        ...
        return self._list_load_balancer_forwarding_rules_oapg(
