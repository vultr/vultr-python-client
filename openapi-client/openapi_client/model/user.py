    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class user(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "api_enabled", "email", "password", "acls", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "api_enabled", "email", "password", "acls", ], str]):
