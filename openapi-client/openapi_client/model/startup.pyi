...
class Startup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "date_created", "date_modified", "name", "script", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "date_created", "date_modified", "name", "script", "type", ], str]):
