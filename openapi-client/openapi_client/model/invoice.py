...
class Invoice(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "date", "description", "amount", "balance", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "date", "description", "amount", "balance", ], str]):
