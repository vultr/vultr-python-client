...
class Region(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "country", "options", "continent", "city", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "country", "options", "continent", "city", ], str]):
