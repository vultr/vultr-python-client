...
class NodepoolInstances(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "label", "date_created", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "label", "date_created", ], str]):
