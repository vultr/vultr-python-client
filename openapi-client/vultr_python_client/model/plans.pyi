...
class Plans(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "vcpu_count", "ram", "disk", "bandwidth", "monthly_cost", "type", "locations", "disk_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "vcpu_count", "ram", "disk", "bandwidth", "monthly_cost", "type", "locations", "disk_count", ], str]):
