...
class PrivateNetworks(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "mac_address", "ip_address", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "mac_address", "ip_address", ], str]):
