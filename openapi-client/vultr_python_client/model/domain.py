...
class Domain(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain", "date_created", "dns_sec", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domain", "date_created", "dns_sec", ], str]):
