...
class BaremetalIpv6(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ip", "network", "network_size", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ip", "network", "network_size", "type", ], str]):
