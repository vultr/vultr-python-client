...
class Os(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "arch", "family", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "arch", "family", ], str]):
