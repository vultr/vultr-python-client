...
class ForwardingRule(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "frontend_protocol", "frontend_port", "backend_protocol", "backend_port", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "frontend_protocol", "frontend_port", "backend_protocol", "backend_port", ], str]):
