...
class Snapshot(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "date_created", "description", "size", "status", "os_id", "app_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "date_created", "description", "size", "status", "os_id", "app_id", ], str]):
