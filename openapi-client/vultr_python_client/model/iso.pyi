...
class Iso(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            md5sum = schemas.StrSchema
            sha512sum = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sha512sum"]) -> MetaOapg.properties.sha512sum: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "date_created", "filename", "size", "md5sum", "sha512sum", "status", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["md5sum"]) -> typing.Union[MetaOapg.properties.md5sum, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sha512sum"]) -> typing.Union[MetaOapg.properties.sha512sum, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "date_created", "filename", "size", "md5sum", "sha512sum", "status", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        md5sum: typing.Union[MetaOapg.properties.md5sum, str, schemas.Unset] = schemas.unset,
        sha512sum: typing.Union[MetaOapg.properties.sha512sum, str, schemas.Unset] = schemas.unset,
