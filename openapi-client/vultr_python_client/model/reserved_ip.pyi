...
class ReservedIp(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "region", "ip_type", "subnet", "subnet_size", "label", "instance_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "region", "ip_type", "subnet", "subnet_size", "label", "instance_id", ], str]):
