...
class BaremetalIpv4(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ip", "netmask", "gateway", "type", "reverse", "mac_address", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ip", "netmask", "gateway", "type", "reverse", "mac_address", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        reverse: typing.Union[MetaOapg.properties.reverse, str, schemas.Unset] = schemas.unset,
