...
class DnsRecord(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "type", "name", "data", "priority", "ttl", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "type", "name", "data", "priority", "ttl", ], str]):
