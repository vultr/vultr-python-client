...
class SchemaFor200ResponseBodyApplicationJson(
        ...
        class properties:
            ...
            class firewall_rules(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirewallRule']:
                        return FirewallRule
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirewallRule'], typing.List['FirewallRule']],
                ...
                def __getitem__(self, i: int) -> 'FirewallRule':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["firewall_rules", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["firewall_rules", "meta", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_firewall_group_rules_oapg(
        self,
...
class ListFirewallGroupRules(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_firewall_group_rules(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_firewall_group_rules(
        ...
        return self._list_firewall_group_rules_oapg(
