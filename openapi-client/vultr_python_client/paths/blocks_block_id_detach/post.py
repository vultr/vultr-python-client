...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["live", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["live", ], str]):
...
class DetachBlock(BaseApi):
    ...
    def detach_block(
        ...
        return self._detach_block_oapg(
            body=body,
