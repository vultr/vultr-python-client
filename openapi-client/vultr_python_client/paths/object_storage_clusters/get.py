        ...
        class properties:
            ...
            class clusters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Clusters']:
                        return Clusters
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Clusters'], typing.List['Clusters']],
                ...
                def __getitem__(self, i: int) -> 'Clusters':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_object_storage_clusters_oapg(
        self,
...
class ListObjectStorageClusters(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_object_storage_clusters(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_object_storage_clusters(
        ...
        return self._list_object_storage_clusters_oapg(
