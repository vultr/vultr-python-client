...
class SchemaFor200ResponseBodyApplicationJson(
        ...
        class properties:
            ...
            class private_networks(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PrivateNetworks']:
                        return PrivateNetworks
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PrivateNetworks'], typing.List['PrivateNetworks']],
                ...
                def __getitem__(self, i: int) -> 'PrivateNetworks':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["private_networks", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["private_networks", "meta", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_instance_private_networks_oapg(
        self,
...
class ListInstancePrivateNetworks(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_instance_private_networks(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def list_instance_private_networks(
        ...
        return self._list_instance_private_networks_oapg(
