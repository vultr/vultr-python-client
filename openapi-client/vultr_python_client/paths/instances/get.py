...
MainIpSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'main_ip': typing.Union[MainIpSchema, str, ],
...
request_query_main_ip = api_client.QueryParameter(
    name="main_ip",
    style=api_client.ParameterStyle.FORM,
    schema=MainIpSchema,
    explode=True,
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["instances", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["instances", "meta", ], str]):
