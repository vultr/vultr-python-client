...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["regions", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["regions", "meta", ], str]):
...
class ListRegions(BaseApi):
    ...
    def list_regions(
        ...
        return self._list_regions_oapg(
