        ...
        class properties:
            ...
            class networks(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Network']:
                        return Network
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Network'], typing.List['Network']],
                ...
                def __getitem__(self, i: int) -> 'Network':
...
class ListNetworks(BaseApi):
    ...
    def list_networks(
        ...
        return self._list_networks_oapg(
