...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["node_pools", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["node_pools", ], str]):
...
class GetNodepools(BaseApi):
    ...
    def get_nodepools(
        ...
        return self._get_nodepools_oapg(
